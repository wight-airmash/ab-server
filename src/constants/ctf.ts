...
export const CTF_AFK_SOFT_LIMIT_TO_AUTO_SPECTATE_MS = 39 * MS_PER_SEC;

export const CTF_AFK_HARD_LIMIT_TO_AUTO_SPECTATE_MS = 3 * SECONDS_PER_MINUTE * MS_PER_SEC;
...
export const CTF_EXTRA_SPAWNS = false;
