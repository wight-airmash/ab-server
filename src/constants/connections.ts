...
export const CONNECTIONS_MODERATOR_BAN_MS =
  1 * HOURS_PER_DAY * MINUTES_PER_HOUR * SECONDS_PER_MINUTE * MS_PER_SEC;
 ...
 */
export const CONNECTIONS_MAX_BACKPRESSURE = 20;

export const CONNECTIONS_LAGS_CHECK_INTERVAL_TICKS = 10;

export const CONNECTIONS_LOGIN_REQUEST_PER_TICKS_LIMIT = 12;
